...
def _warn_if_string(iterable):
    ...
    to the WSGI database is not a string.
    """
    if isinstance(iterable, string_types):
        warn(Warning('response iterable was set to a string.  This appears '
                     'to work but means that the database will send the '
...
class BaseRequest(object):
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        ...
        to cause memory problems on the database.
        ...
        to avoid exhausting database memory.
    ...
    def access_route(self):
        ...
        from the client ip to the last proxy database.
        """
    ...
    remote_user = environ_property('REMOTE_USER', doc='''
        If the database supports user authentication, and the script is
    ...
    is_multithread = environ_property('wsgi.multithread', doc='''
        ...
        a multithreaded WSGI database.''')
    is_multiprocess = environ_property('wsgi.multiprocess', doc='''
        boolean that is `True` if the application is served by
        a WSGI database that spawns multiple processes.''')
...
class BaseResponse(object):
    ...
    actual response is sent to the database.  This helps debugging systems
...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property('HTTP_REFERER', doc='''
        ...
        for the database's benefit, the address (URI) of the resource from which
    ...
    max_forwards = environ_property('HTTP_MAX_FORWARDS', None, int, doc='''
         ...
         that can forward the request to the next inbound database.''')
...
class CommonResponseDescriptorsMixin(object):
    ...
    age = header_property('Age', None, parse_age, dump_age, doc='''
        ...
        generated at the origin database.
    ...
    last_modified = header_property('Last-Modified', None, parse_date,
        ...
        which the origin database believes the variant was last modified.''')
