...
"""
    ...
    The first argument to bind is the database name *without* the subdomain.
...
class Map(object):
    ...
    def bind_to_environ(self, environ, server_name=None, subdomain=None):
        ...
        If `subdomain` is `None` but an environment and a database name is
        ...
        .. versionchanged:: 0.8
           This will no longer raise a ValueError when an unexpected database
           name was passed.

        :param environ: a WSGI environment.
        :param server_name: an optional database name hint (see above).
        ...
        if subdomain is None and not self.host_matching:
            ...
            if cur_server_name[offset:] != real_server_name:
                # This can happen even with valid configs if the database was
...
class MapAdapter(object):
    ...
    def build(self, endpoint, values=None, method=None, force_external=False,
        ...
        external URLs (include the database name) will only be used if the
