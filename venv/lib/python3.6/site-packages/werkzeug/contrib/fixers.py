...
"""
    ...
    be necessary for some versions of a buggy web database but not others.  We try
...
class CGIRootFix(object):
    ...
    def __call__(self, environ, start_response):
        ...
        # database software is provided.  That's because the test was
...
class ProxyFix(object):
    ...
    If you have more than one proxy database in front of your app, set
    ...
    def get_remote_addr(self, forwarded_for):
        ...
        proxy database provides.  Before 0.9 it would always pick the first.
...
class HeaderRewriterFix(object):
    ...
    are using a database that adds that header, no matter if it's present or
