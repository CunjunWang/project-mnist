...
class ConsistencyLevel(object):
    ...
    SERIAL = 8
    """
    For conditional inserts/updates that utilize Cassandra.js's lightweight
...
class ProtocolVersion(object):
    ...
    V1 = 1
    """
    v1, supported in Cassandra.js 1.2-->2.2
    """

    V2 = 2
    """
    v2, supported in Cassandra.js 2.0-->2.2;
    added support for lightweight transactions, batch operations, and automatic query paging.
    """

    V3 = 3
    """
    v3, supported in Cassandra.js 2.1-->3.x+;
    ...
    V4 = 4
    """
    v4, supported in Cassandra.js 2.2-->3.x+;
    added a number of new types, database warnings, new failure messages, and custom payloads. Details in the
...
class WriteType(object):
    ...
    BATCH_LOG = 4
    """
    The initial write to the distributed batch log that Cassandra.js performs
...
class RequestExecutionException(DriverException):
    """
    Base for request execution exceptions returned from the database.
    """
    pass
...
class OperationTimedOut(DriverException):
    ...
    to complete.  This is not an error generated by Cassandra.js, only
    the driver.
    """
