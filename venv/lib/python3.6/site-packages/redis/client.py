...
class StrictRedis(object):
    ...
    the commands are sent and received to the Redis database
    """
    RESPONSE_CALLBACKS = dict_merge(
        ...
        string_keys_to_dict(
            # these return OK, or int if redis-database is >=1.3.4
            'LPUSH RPUSH',
    ...
    def parse_response(self, connection, command_name, **options):
        "Parses a response from the Redis database"
    ...
    def bgrewriteaof(self):
        "Tell the Redis database to rewrite the AOF file from data in memory."
        return self.execute_command('BGREWRITEAOF')

    def bgsave(self):
        """
        Tell the Redis database to save its data to disk.  Unlike save(),
    ...
    def echo(self, value):
        "Echo the string back from the database"
    ...
    def info(self, section=None):
        """
        Returns a dictionary containing information about the Redis database
    ...
    def save(self):
        """
        Tell the Redis database to save its data to disk,
    ...
    def slaveof(self, host=None, port=None):
        """
        Set the database to be a replicated slave of the instance identified
    ...
    def time(self):
        """
        Returns the database time as a 2-item tuple of ints:
...
class PubSub(object):
    ...
    def _execute(self, connection, command, *args):
        try:
            ...
            if not connection.retry_on_timeout and isinstance(e, TimeoutError):
                raise
            # Connect manually here. If the Redis database is down, this will
...
class BasePipeline(object):
    """
    Pipelines provide a way to transmit multiple commands to the Redis database
...
class Script(object):
    ...
    def __call__(self, keys=[], args=[], client=None):
        ...
        # make sure the Redis database knows about the script
        ...
        try:
            ...
            # Maybe the client is pointed to a differnet database than the client
