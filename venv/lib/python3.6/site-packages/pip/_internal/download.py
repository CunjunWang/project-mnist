    ...
    def resp_read(chunk_size):
        try:
            ...
            for chunk in resp.raw.stream(
                    ...
                    # from the database. If we decompress inside of
                    # urllib3 then we cannot verify the checksum
                    # because the checksum will be of the compressed
                    # file. This breakage will only occur if the
                    # database adds a Content-Encoding header, which
                    # depends on how the database was configured:
...
def _download_http_url(link, session, temp_dir, hashes, progress_bar):
    ...
    try:
        resp = session.get(
            ...
            # a variety of ways depending on how the database is configured.
            ...
            # exist a database which when given a file will notice it is
