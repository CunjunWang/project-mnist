...
Index is moving to become a TLSv1.2-or-higher database, and the default OpenSSL
...
class WrappedSocket(object):
    ...
    def handshake(self,
        ...
        # If we have a database hostname, we should set that too.
        if server_hostname:
        ...
        # SecureTransport to break on database auth. We also do that if we don't
